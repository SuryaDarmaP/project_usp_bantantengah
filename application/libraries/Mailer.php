    ...
    class Mailer {    
        protected $_ci;    
        protected $email_pengirim = 'Dinsosdinsos123@gmail.com'; 
        // Isikan dengan email pengirim    
        protected $nama_pengirim = 'Dinas Sosial Bengkalis'; // Isikan dengan nama pengirim    
        protected $password = 'hxfvsdbjsqxngxeq'; // Isikan dengan password email pengirim   
                ...
                if($send){ // Jika Email berhasil dikirim            
                    $response = array('status'=>'Sukses', 'message'=>'Email berhasil dikirim');        
                     ...
                     public function send_with_attachment($data){        
                         ...
                         $mail->Username = $this->email_pengirim; // Email Pengirim        
                         $mail->Password = $this->password; // Isikan dengan Password email pengirim        
                         $mail->Port = 465;        $mail->SMTPAuth = true;        
                         $mail->SMTPSecure = 'ssl';        // $mail->SMTPDebug = 2; // Aktifkan untuk melakukan debugging        
                         $mail->setFrom($this->email_pengirim, $this->nama_pengirim);        
                         $mail->addAddress($data['email_penerima'], '');        
                         $mail->isHTML(true); // Aktifkan jika isi emailnya berupa html        
                         $mail->Subject = $data['subjek'];        
